...
#encoding: utf-8
#import timm
#import spaces # pip install spaces
import gradio as gr
...
# PYTORCH_ENABLE_MPS_FALLBACK=1 python web_demo.py --device mps --dtype fp16importerror: cannot import name 'CommitOperationAdd' from 'huggingface_hub' (m:\Projects\envs\AIdeaTextMulti\Lib\site-packages\huggingface_hub\__init__.py)Output is truncated. View as a scrollable element or open in a text editor. Adjust cell output settings...
