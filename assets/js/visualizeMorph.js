document.addEventListener("DOMContentLoaded", function() {
    ...
    handleProcess(morphButton, morphContainer, "text-morph", 'https://5f6b6akff7.execute-api.us-east-2.amazonaws.com/DEV/morphAnalyzer');

    function visualizeSyntaxTreemap(morphData, container) {
        clearContainer(container);

        if (!morphData || !morphData.nodes) {
